...
const stageNameMapping: Record<string, string> = {
  ...
  "убеждение_на_бесплатные_лиды": "Убеждение на бесплатные лиды",
  "отправка_бесплатных_лидов": "Отправка бесплатных лидов",
  "завершен_на_предложении_лидов": "Завершен на предложении лидов",
  "убеждение_на_подписку": "Убеждение на подписку",
  "отправка_ссылки_на_оплату": "Отправка ссылки на оплату",
  "завершен_на_предложении_подписки": "Завершен на предложении подписки",
  "убеждение_на_пробную_подписку": "Убеждение на пробную подписку",
  "отправка_ссылки_на_оплату_пробного_периода": "Отправка ссылки на пробный период",
  "ожидание_подтверждения_подписки": "Ожидание подтверждения подписки",
  "ожидание_подтверждения_пробной_подписки": "Ожидание подтверждения пробной подписки",
  "подписка_оплачена": "Подписка оплачена",
  "пробная_подписка_оплачена": "Пробная подписка оплачена"
};
